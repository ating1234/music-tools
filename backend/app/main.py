...
@app.post("/api/jobs/transform", response_model=JobResponse)
...
@app.post("/api/jobs/separate-vocals", response_model=JobResponse)
...
@app.post("/api/jobs/separate-instruments", response_model=JobResponse)
